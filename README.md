...
| --- | --- | --- |
| 欢迎页 | `/` | 品牌说明，提供登录与注册入口 |
| 登录 / 注册 | `/auth.html` | 邮箱密码注册、已有账号登录；注册后进入编辑页，登录后进入名片夹 |
| 我的名片 | `/editor.html` | 同时录入姓名、公司/组织、部门和职务；支持纸质名片 OCR、粘贴文字智能填写、语音定点修改、头像/微信二维码、官网产品抓取与产品管理 |
| 公开名片 | `/card.html?slug=...` | 3:2 实体名片比例 + 左图右文产品目录，无需登录即可访问 |
| 名片夹 | `/directory.html?slug=...` | 双栏联系人工作台：左侧姓名与关键词，右侧完整名片和产品；支持每 10 张一段的序号范围下拉浏览，内置 18 个模拟联系人用于界面演示 |
